@guiaProrrogacao
Feature: Cenário de Negócio - GUIA DE PRORROGAÇÃO
...
#51029008
  ...
  Scenario Outline: Cadastrar guia De Prorrogação
    ...
    Examples:
      ...
      | INTERNAÇÃO | 51029008   | Prestador | 11000603       | 558449             | Indicação clinica | TUSS -- Procedimentos e eventos em saúde | 10102019        | 1        |