...
public class Wait {
	...
	public static void untilValueEquals(WebDriver driver, Long timeoutInSeconds, WebElement elemento, String valor) {
		until(driver, new Function<WebDriver, Boolean>() {
			public Boolean apply(WebDriver t) {
				Boolean valorCampoIgual = (elemento.getAttribute("value") == valor);
				if (!valorCampoIgual)
					;
				return valorCampoIgual;
			}
		}, timeoutInSeconds);
	}
